...
public class DummyNetworkInterface extends NetworkInterface {

	public DummyNetworkInterface(Settings s) {
		super(s);
	}

	public DummyNetworkInterface(DummyNetworkInterface ti) {
		super(ti);
	}
