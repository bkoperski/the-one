...
public class ModuleCommunicationBusTest {
	...
	public void testUpdateDouble() {
		...
		assertEquals(16.5, b.updateDouble(key, 1.0), 0.01);
		assertEquals(16.5, b.getDouble(key, -1.0), 0.01);

		assertEquals(13.3, b.updateDouble(key, -3.2), 0.01);
		assertEquals(13.3, b.getDouble(key, -1.0), 0.01);

		assertEquals(-16.7, b.updateDouble(key, -30), 0.01);
		assertEquals(-16.7, b.getDouble(key, -1.0), 0.01);
	}
